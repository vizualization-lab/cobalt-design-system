...
import {
  storybookComponentDefinitions as componentConfigs,
  storybookPlaygroundDefaults as playgroundDefaults,
  storybookPropOverrides as propOverrides,
  storybookSlotControls as slotControls,
...
function collectUnionTypeAliases() {
  const sourcePaths = [...new Set(componentConfigs.map((config) => config.componentSource))];
