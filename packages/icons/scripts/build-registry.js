...
`;
  ...
  const dts = `// Auto-generated by build-registry.js — do not edit

import type { IconDescriptor } from '${registerImport}';

declare const descriptor: IconDescriptor;
export { descriptor as ${exportName} };
export default descriptor;
`;
  writeFileSync(filePath.replace(/\.js$/, '.d.ts'), dts);
}
