...
The current designer onboarding docs call out three libraries:

- **Cobalt Components**
- **Cobalt Icons**
- **Cobalt Tokens**

If you are doing general product work, enable all three. If you only need token-aware handoff or audits, the tokens library is still essential.
