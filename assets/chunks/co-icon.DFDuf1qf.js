import{A as m,E as p,a as g,n as a,t as u,i as v,b as y}from"./property.CwPs_2Bc.js";import{i as b,t as w,e as x}from"./directive.CJw_OlP2.js";import{g as z,a as C,c as $,o as S}from"./theme.BiDdl5rI.js";import"./framework.DW6FvQZQ.js";/**
 * @license
...
`;var r=function(n,t,e,s){var c=arguments.length,i=c<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,e):s,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,t,e,s);else for(var h=n.length-1;h>=0;h--)(l=n[h])&&(i=(c<3?l(i):c>3?l(t,e,i):l(t,e))||i);return c>3&&i&&Object.defineProperty(t,e,i),i};let o=class extends v{constructor(){super(...arguments),this.name="",this.size="md",this.fill=!1,this.animated=!1}async replay(){if(!this.animated){this.animated=!0,await this.updateComplete;return}this.animated=!1,await this.updateComplete,this.getBoundingClientRect(),this.animated=!0,await this.updateComplete}render(){const t=this.animated&&z(this.name,"rounded",this.fill)||C(this.name,"rounded",this.fill);if(!t)return m;const e=!this.label,s=$.has(this.name)||S.has(this.name)?"0 0 24 24":"0 -960 960 960";return y`
    ...
    `}};o.styles=[I];r([a({reflect:!0})],o.prototype,"name",void 0);r([a({reflect:!0})],o.prototype,"size",void 0);r([a({type:Boolean,reflect:!0})],o.prototype,"fill",void 0);r([a({type:Boolean,reflect:!0})],o.prototype,"animated",void 0);r([a()],o.prototype,"label",void 0);o=r([u("co-icon")],o);export{o as CoIcon};
