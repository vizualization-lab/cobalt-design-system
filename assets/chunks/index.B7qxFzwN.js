...
`;var Be=function(s,t,e,i){var o=arguments.length,r=o<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,t,e,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(t,e,r):n(t,e))||r);return o>3&&r&&Object.defineProperty(t,e,r),r};let _e=class extends J{constructor(){super(...arguments),this.name="",this.size="md",this.fill=!1,this.animated=!1}async replay(){if(!this.animated){this.animated=!0,await this.updateComplete;return}this.animated=!1,await this.updateComplete,this.getBoundingClientRect(),this.animated=!0,await this.updateComplete}render(){const t=this.animated&&As(this.name,"rounded",this.fill)||Ss(this.name,"rounded",this.fill);if(!t)return S;const e=!this.label,i=Ts.has(this.name)||Os.has(this.name)?"0 0 24 24":"0 -960 960 960";return v`
    ...
    `}};Ue([A({reflect:!0})],Ee.prototype,"variant",void 0);Ue([A({reflect:!0})],Ee.prototype,"size",void 0);Ue([A({type:Boolean,reflect:!0})],Ee.prototype,"loading",void 0);Ue([A({reflect:!0})],Ee.prototype,"href",void 0);Ue([A({reflect:!0})],Ee.prototype,"target",void 0);Ee=Ue([ne("co-button")],Ee);const uo=U`
  /* ── Base ── */
  :host {
    display: inline-flex;
    vertical-align: middle;
...
`;var He=function(s,t,e,i){var o=arguments.length,r=o<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,t,e,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(t,e,r):n(t,e))||r);return o>3&&r&&Object.defineProperty(t,e,r),r};const po={sm:"xs",md:"sm",lg:"md",xl:"lg"};let we=class extends Ji{constructor(){super(...arguments),this.name="",this.variant="primary",this.size="md",this.labelPosition="bottom",this._handleFocus=()=>{this.dispatchEvent(new CustomEvent("co-focus",{bubbles:!0,composed:!0}))},this._handleBlur=()=>{this.dispatchEvent(new CustomEvent("co-blur",{bubbles:!0,composed:!0}))}}static get styles(){return[...super.styles,uo]}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._handleFocus),this.addEventListener("blur",this._handleBlur)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("focus",this._handleFocus),this.removeEventListener("blur",this._handleBlur)}render(){const t=po[this.size],e=!!this.label,i=e?v`<span part="label" class="label">${this.label}</span>`:S;return v`
