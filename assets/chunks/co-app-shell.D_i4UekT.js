import{E as g,i as b,a as f,A as p,b as l,t as m}from"./custom-element.CPWKJEuj.js";import{e as y,i as k,t as D}from"./directive.CJw_OlP2.js";import{n as v}from"./property.C8dt_fM1.js";import{r as d}from"./state.DiIG59Fj.js";import{e as u}from"./query.BApjzB0v.js";import{C as $}from"./tokens.DaM6lqEM.js";import"./co-icon.Coczem8N.js";import"./theme.CMAuE89p.js";import"./framework.BeCEba4t.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const w="important",z=" !"+w,_=y(class extends k{constructor(r){var e;if(super(r),r.type!==D.ATTRIBUTE||r.name!=="style"||((e=r.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(r){return Object.keys(r).reduce((e,t)=>{const a=r[t];return a==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(r,[e]){const{style:t}=r.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const a of this.ft)e[a]==null&&(this.ft.delete(a),a.includes("-")?t.removeProperty(a):t[a]=null);for(const a in e){const n=e[a];if(n!=null){this.ft.add(a);const o=typeof n=="string"&&n.endsWith(z);a.includes("-")||o?t.setProperty(a,o?n.slice(0,-11):n,o?w:""):t[a]=n}}return g}}),x=b`
  :host {
    display: block;
    block-size: 100dvh;
