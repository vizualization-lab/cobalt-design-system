import{i as h,b as d,A as u,t as f}from"./custom-element.CPWKJEuj.js";import{n as c}from"./property.C8dt_fM1.js";import"./co-icon.IqpmMpu5.js";import{L as b}from"./LionButton.v50-PCNC.js";import"./directive.CJw_OlP2.js";import"./theme.CDHuWmwp.js";import"./framework.BeCEba4t.js";import"./DisabledMixin.DvWrDoIe.js";const p=h`
  /* ── Base ── */
  :host {
    display: inline-flex;
...
`;var i=function(n,t,o,e){var s=arguments.length,r=s<3?t:e===null?e=Object.getOwnPropertyDescriptor(t,o):e,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(n,t,o,e);else for(var v=n.length-1;v>=0;v--)(l=n[v])&&(r=(s<3?l(r):s>3?l(t,o,r):l(t,o))||r);return s>3&&r&&Object.defineProperty(t,o,r),r};const m={sm:"xs",md:"sm",lg:"md"};let a=class extends b{constructor(){super(...arguments),this.name="",this.variant="primary",this.size="md",this.labelPosition="bottom",this.circle=!1,this._handleFocus=()=>{this.dispatchEvent(new CustomEvent("co-focus",{bubbles:!0,composed:!0}))},this._handleBlur=()=>{this.dispatchEvent(new CustomEvent("co-blur",{bubbles:!0,composed:!0}))},this._handleClick=t=>{if(t.defaultPrevented||this.disabled||this.type!=="submit"&&this.type!=="reset")return;const o=this.closest("form");if(!o)return;if(t.preventDefault(),this.type==="reset"){o.reset();return}const e=o.requestSubmit;if(typeof e=="function"){e.call(o);return}o.dispatchEvent(new Event("submit",{bubbles:!0,cancelable:!0}))}}static get styles(){return[...super.styles,p]}connectedCallback(){super.connectedCallback(),this.addEventListener("focus",this._handleFocus),this.addEventListener("blur",this._handleBlur),this.addEventListener("click",this._handleClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("focus",this._handleFocus),this.removeEventListener("blur",this._handleBlur),this.removeEventListener("click",this._handleClick)}render(){const t=m[this.size],o=!!this.label&&!this.circle,e=o?d`<span part="label" class="label">${this.label}</span>`:u;return d`
      <div part="base" class="button-icon ${o?"has-label":""}">
        ${this.labelPosition==="top"?e:u}
        <co-icon part="icon" name=${this.name} size=${t} aria-hidden="true"></co-icon>
        ${this.labelPosition==="bottom"?e:u}
      </div>
