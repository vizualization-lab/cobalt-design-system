...
`;var J=function(r,e,t,o){var i=arguments.length,s=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(e,t,s):a(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s};let T=class extends Xe{constructor(){super(...arguments),this.required=!1,this.requiredMessage="",this._validation=new z(this),this._handleModelValueChanged=e=>{var o;const t=e;t.target!==this||(o=t.detail)!=null&&o.initialize||this.dispatchEvent(new CustomEvent("co-change",{detail:{value:this.modelValue,modelValue:this.modelValue},bubbles:!0,composed:!0}))}}static get styles(){return[...super.styles,Je]}connectedCallback(){super.connectedCallback(),this.addEventListener("model-value-changed",this._handleModelValueChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("model-value-changed",this._handleModelValueChanged)}firstUpdated(e){y(this),super.firstUpdated(e),this._syncValidation(!0,!0)}updated(e){y(this),super.updated(e),(e.has("validators")||e.has("required")||e.has("requiredMessage"))&&this._syncValidation(e.has("validators"),e.has("required")||e.has("requiredMessage"))}render(){return c`
    ...
    `}_syncValidation(e=!1,t=!1){this._validation.sync(()=>this.required?[I(this.requiredMessage,"Select an option.")]:[],e,t)}};J([l({type:Boolean,reflect:!0})],T.prototype,"required",void 0);J([l({attribute:"required-message"})],T.prototype,"requiredMessage",void 0);T=J([v("co-radio-group")],T);export{K as ChoiceGroupMixin,Ht as CoAppShell,Kt as CoBanner,Zt as CoButton,Rt as CoButtonIcon,Xt as CoCard,$ as CoCheckbox,A as CoCheckboxGroup,j as CoCheckboxIndeterminate,d as CoCombobox,H as CoForm,Qt as CoIcon,Bt as CoInput,Gt as CoInputPill,k as CoLabel,b as CoListbox,Co as CoModeToggle,Vo as CoNavDrawer,Oo as CoNavDrawerGroup,Mo as CoNavDrawerItem,Eo as CoNavHeaderBar,zo as CoNavRailBar,$t as CoNavRailItem,To as CoNavSeparator,to as CoOption,P as CoRadio,T as CoRadioGroup,mo as CoSelect,So as CoTextarea,wt as DefaultSuccess,io as EqualsLength,so as FocusMixin,Ee as FormControlMixin,xe as FormControlsCollection,W as FormGroupMixin,vo as FormRegisteringMixin,ge as FormRegistrarMixin,_o as FormRegistrarPortalMixin,go as FormatMixin,ro as InteractionStateMixin,xt as IsDate,Et as IsDateDisabled,ao as IsEmail,_t as IsNumber,no as IsString,qo as LionField,xo as LionValidationFeedback,Ct as MaxDate,lo as MaxLength,vt as MaxNumber,yt as MinDate,co as MinLength,kt as MinMaxDate,uo as MinMaxLength,gt as MinMaxNumber,bt as MinNumber,Ro as NativeTextFieldMixin,ho as Pattern,po as Required,Ae as ResultValidator,G as Unparseable,we as ValidateMixin,m as Validator};
