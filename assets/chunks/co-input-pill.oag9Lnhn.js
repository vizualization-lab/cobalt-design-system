import{a as _,b as c,A as h,n as r,t as x}from"./property.CwPs_2Bc.js";import{C as z,e as y,c as L,f as k,a as w,i as g,b as C,d as E}from"./validation.DxHnL4dS.js";import{N as I,L as M}from"./NativeTextFieldMixin.BZecRt_V.js";import"./co-icon.DFDuf1qf.js";import{L as N}from"./LionButton.Duym_-hY.js";import"./DisabledMixin.DvWrDoIe.js";import"./FormatMixin.DR2Wprwa.js";import"./framework.DW6FvQZQ.js";import"./directive.CJw_OlP2.js";import"./theme.BiDdl5rI.js";class T extends I(M){static get properties(){return{readOnly:{type:Boolean,attribute:"readonly",reflect:!0},type:{type:String,reflect:!0},placeholder:{type:String,reflect:!0}}}get slots(){return{...super.slots,input:()=>{const e=document.createElement("input"),t=this.getAttribute("value");return t&&e.setAttribute("value",t),e}}}get _inputNode(){return super._inputNode}constructor(){super(),this.readOnly=!1,this.type="text",this.placeholder=""}requestUpdate(e,t,o){super.requestUpdate(e,t,o),e==="readOnly"&&this.__delegateReadOnly()}firstUpdated(e){super.firstUpdated(e),this.__delegateReadOnly()}updated(e){super.updated(e),e.has("type")&&(this._inputNode.type=this.type),e.has("placeholder")&&(this._inputNode.placeholder=this.placeholder),e.has("disabled")&&(this._inputNode.disabled=this.disabled,this.validate()),e.has("name")&&(this._inputNode.name=this.name),e.has("autocomplete")&&(this._inputNode.autocomplete=this.autocomplete)}__delegateReadOnly(){this._inputNode&&(this._inputNode.readOnly=this.readOnly)}}const A=_`
  :host {
    display: block;
...
`;var u=function(a,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,o);else for(var d=a.length-1;d>=0;d--)(s=a[d])&&(i=(n<3?s(i):n>3?s(e,t,i):s(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let l=class extends T{constructor(){super(...arguments),this.size="md",this.danger=!1,this.required=!1,this.requiredMessage="",this.emailMessage="",this.pattern="",this.patternMessage="",this.minLengthMessage="",this.maxLengthMessage="",this._validation=new z(this),this._handleFocusIn=()=>{this.dispatchEvent(new CustomEvent("co-focus",{bubbles:!0,composed:!0}))},this._handleFocusOut=()=>{this.dispatchEvent(new CustomEvent("co-blur",{bubbles:!0,composed:!0}))},this._handleNativeInput=e=>{e.target===this._inputNode&&this._dispatchValueEvent("co-input")},this._handleNativeChange=e=>{e.target===this._inputNode&&this._dispatchValueEvent("co-change")}}static get styles(){return[...super.styles,A]}connectedCallback(){super.connectedCallback(),this.addEventListener("focusin",this._handleFocusIn),this.addEventListener("focusout",this._handleFocusOut),this.addEventListener("input",this._handleNativeInput),this.addEventListener("change",this._handleNativeChange)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("focusin",this._handleFocusIn),this.removeEventListener("focusout",this._handleFocusOut),this.removeEventListener("input",this._handleNativeInput),this.removeEventListener("change",this._handleNativeChange)}firstUpdated(e){y(this),super.firstUpdated(e),this._syncNativeLengthAttributes(),this._syncValidation(!0,!0)}updated(e){y(this),super.updated(e),(e.has("maxLength")||e.has("minLength"))&&this._syncNativeLengthAttributes(),this._validationPropsChanged(e)&&this._syncValidation(e.has("validators"),this._validationRulesChanged(e))}_labelTemplate(){return c`
    ...
    `}_dispatchValueEvent(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this._inputNode.value,modelValue:this.modelValue},bubbles:!0,composed:!0}))}_syncValidation(e=!1,t=!1){this._validation.sync(()=>{const o=[];return this.required&&o.push(L(this.requiredMessage,"Enter a value.")),this.type==="email"&&o.push(k(this.emailMessage)),this.pattern&&o.push(w(this.pattern,this.patternMessage)),g(this.minLength)&&o.push(C(this.minLength,this.minLengthMessage)),g(this.maxLength)&&o.push(E(this.maxLength,this.maxLengthMessage)),o},e,t)}_validationPropsChanged(e){return["validators","required","requiredMessage","emailMessage","type","pattern","patternMessage","minLength","minLengthMessage","maxLength","maxLengthMessage"].some(o=>e.has(o))}_validationRulesChanged(e){return["required","requiredMessage","emailMessage","type","pattern","patternMessage","minLength","minLengthMessage","maxLength","maxLengthMessage"].some(o=>e.has(o))}_syncNativeLengthAttributes(){const e=this._inputNode;e&&(g(this.maxLength)?e.maxLength=this.maxLength:e.removeAttribute("maxlength"),g(this.minLength)?e.minLength=this.minLength:e.removeAttribute("minlength"))}};u([r({reflect:!0})],l.prototype,"size",void 0);u([r({type:Boolean,reflect:!0})],l.prototype,"danger",void 0);u([r({type:Boolean,reflect:!0})],l.prototype,"required",void 0);u([r({attribute:"required-message"})],l.prototype,"requiredMessage",void 0);u([r({attribute:"email-message"})],l.prototype,"emailMessage",void 0);u([r({reflect:!0})],l.prototype,"pattern",void 0);u([r({attribute:"pattern-message"})],l.prototype,"patternMessage",void 0);u([r({type:Number,attribute:"maxlength",reflect:!0})],l.prototype,"maxLength",void 0);u([r({type:Number,attribute:"minlength",reflect:!0})],l.prototype,"minLength",void 0);u([r({attribute:"minlength-message"})],l.prototype,"minLengthMessage",void 0);u([r({attribute:"maxlength-message"})],l.prototype,"maxLengthMessage",void 0);l=u([x("co-input")],l);const O=_`
