...
`;let U=!1;typeof document<"u"&&(document.addEventListener("keydown",()=>{U=!0}),document.addEventListener("mousedown",()=>{U=!1}));function X(r){r.addEventListener("focusin",()=>{U&&r.setAttribute("_keyboard-focus","")}),r.addEventListener("focusout",()=>{r.removeAttribute("_keyboard-focus")})}var le=function(r,e,t,o){var i=arguments.length,s=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(e,t,s):a(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s};let $=class extends ne{constructor(){super(...arguments),this.__forwardingClick=!1}static get styles(){return[...super.styles,Se]}get value(){return typeof this.choiceValue=="string"?this.choiceValue:""}set value(e){const t=this.value;this.choiceValue!==e&&(this.choiceValue=e),this.requestUpdate("value",t)}connectedCallback(){super.connectedCallback(),X(this)}render(){return c`
      <div
        part="base"
        class="checkbox"
    ...
    `}_onMousedown(e){var t;((t=e.target)==null?void 0:t.slot)!=="input"&&e.preventDefault()}_onCheckboxClick(e){if(this.__forwardingClick||this.disabled)return;const t=e.target,o=this._inputNode;!o||t===o||t instanceof HTMLLabelElement||(this.__forwardingClick=!0,o.click(),o.focus(),this.__forwardingClick=!1)}};le([l({reflect:!0})],$.prototype,"value",null);$=le([v("co-checkbox")],$);const De=_`
  :host {
    display: block;
    font-family: var(--co-font-family-sans);
    color: var(--co-color-text-default);
...
`;var ce=function(r,e,t,o){var i=arguments.length,s=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(e,t,s):a(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s};let j=class extends Ie{static get styles(){return[...super.styles,qe]}get value(){return typeof this.choiceValue=="string"?this.choiceValue:""}set value(e){const t=this.value;this.choiceValue!==e&&(this.choiceValue=e),this.requestUpdate("value",t)}connectedCallback(){super.connectedCallback(),X(this)}get _indicatorIconName(){return this.indeterminate?"indeterminate-check-box":this.checked?"check-box":"check-box-outline-blank"}render(){return c`
      <div
        part="base"
        class="checkbox"
        @mousedown=${this._onMousedown}
    ...
    `}_syncValidation(e=!1,t=!1){this._validation.sync(()=>this.required?[I(this.requiredMessage,"Select at least one option.")]:[],e,t)}};Y([l({type:Boolean,reflect:!0})],A.prototype,"required",void 0);Y([l({attribute:"required-message"})],A.prototype,"requiredMessage",void 0);A=Y([v("co-checkbox-group")],A);const V=new WeakMap;function de(r,e){Array.from(r.childNodes).forEach(t=>{if(t.nodeName==="#text"){const o=new RegExp(`^(.*?)(${e})(.*)$`,"i"),i=t.nodeValue.match(o);if(i){const s=document.createTextNode(i[1]);r.appendChild(s);const a=document.createElement("b");a.textContent=i[2],r.appendChild(a);const n=document.createTextNode(i[3]);r.appendChild(n),r.removeChild(t),V.set(r,()=>{r.appendChild(t),r.contains(s)&&s.parentNode!==null&&s.parentNode.removeChild(s),r.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a),r.contains(n)&&n.parentNode!==null&&n.parentNode.removeChild(n)})}}else de(t,e)})}function ue(r){V.has(r)&&V.get(r)(),Array.from(r.childNodes).forEach(e=>{e.nodeName==="#text"?V.has(e)&&V.get(e)():ue(e)})}class Z extends m{static get validatorName(){return"MatchesOption"}execute(e,t,o){return(o==null?void 0:o.node.modelValue)instanceof G}}function N(r){return Array.isArray(r)?r:[r]}const Re=r=>class extends K(r){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:"allow-custom-choice"},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(t){if(super.modelValue=t,t==null||t==="")this._customChoices=new Set;else if(this.allowCustomChoice){const o=this.modelValue;this._customChoices=new Set(N(t)),this.requestUpdate("modelValue",o)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(t){if(super.formattedValue=t,t==null)this._customChoices=new Set;else if(this.allowCustomChoice){const o=this.modelValue;this._customChoices=new Set(N(t).map(i=>{var s;return((s=this.formElements.find(a=>a.formattedValue===i))==null?void 0:s.modelValue)||i})),this.requestUpdate("modelValue",o)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(t){if(super.serializedValue=t,t==null)this._customChoices=new Set;else if(this.allowCustomChoice){const o=this.modelValue;this._customChoices=new Set(N(t).map(i=>{var s;return((s=this.formElements.find(a=>a.serializedValue===i))==null?void 0:s.modelValue)||i})),this.requestUpdate("modelValue",o)}}get customChoices(){if(!this.allowCustomChoice)return[];const t=this._getCheckedElements();return Array.from(this._customChoices).filter(o=>!t.some(i=>i.choiceValue===o))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(t){const o=t;return this.allowCustomChoice?this.multipleChoice?[...N(o),...this.customChoices]:o===""?this._customChoices.values().next().value||"":o:o}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(t){return this.allowCustomChoice&&Array.isArray(t)?t.filter(o=>o.trim()!==""):t}},Be=ae(Re),B=new WeakMap;class Ge extends Oe(ye(Be(re))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:"match-mode"},showAllOnEmpty:{type:Boolean,attribute:"show-all-on-empty"},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:"allow-custom-choice"},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,_`
        .input-group__input {
          display: flex;
          flex: 1;
        }
 ...
 */const Ke=r=>r??w;var O=function(r,e,t,o){var i=arguments.length,s=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(e,t,s):a(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s},M;let k=M=class extends L{constructor(){super(...arguments),this.required=!1,this.optional=!1,this.optionalLabel="(optional)",this._addedLabelledByToken=!1,this._handleClick=()=>{var t;if(!this.htmlFor)return;const e=(t=this.ownerDocument)==null?void 0:t.getElementById(this.htmlFor);e instanceof HTMLElement&&queueMicrotask(()=>{var o;this._hasFocusWithin(e)||(e.focus(),!this._hasFocusWithin(e)&&((o=this._findFocusableDescendant(e))==null||o.focus()))})}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._handleClick)}disconnectedCallback(){this.removeEventListener("click",this._handleClick),this._clearTargetLabelling(),super.disconnectedCallback()}firstUpdated(){this._syncTargetLabelling()}updated(e){e.has("htmlFor")&&this._syncTargetLabelling()}render(){return c`
    ...
    `}_optionalTemplate(){return this.required||!this.optional||!this.optionalLabel?w:c`<span class="co-label__optional">${this.optionalLabel}</span>`}_syncTargetLabelling(){var s;if(this._clearTargetLabelling(),!this.htmlFor)return;const e=(s=this.ownerDocument)==null?void 0:s.getElementById(this.htmlFor);if(!(e instanceof HTMLElement))return;const t=this._labelId(),o=this._ariaLabelledByTokens(e),i=o.includes(t);i||e.setAttribute("aria-labelledby",[...o,t].join(" ")),this._labelledTarget=e,this._labelledTargetToken=t,this._addedLabelledByToken=!i}_clearTargetLabelling(){if(!this._labelledTarget||!this._labelledTargetToken||!this._addedLabelledByToken){this._labelledTarget=void 0,this._labelledTargetToken=void 0,this._addedLabelledByToken=!1;return}const e=this._ariaLabelledByTokens(this._labelledTarget).filter(t=>t!==this._labelledTargetToken);e.length>0?this._labelledTarget.setAttribute("aria-labelledby",e.join(" ")):this._labelledTarget.removeAttribute("aria-labelledby"),this._labelledTarget=void 0,this._labelledTargetToken=void 0,this._addedLabelledByToken=!1}_labelId(){return this.id||(M._nextGeneratedId+=1,this.id=`co-label-${M._nextGeneratedId}`),this.id}_ariaLabelledByTokens(e){return(e.getAttribute("aria-labelledby")??"").split(/\s+/).filter(Boolean)}_hasFocusWithin(e){var t;return e.matches(":focus-within")||((t=this.ownerDocument)==null?void 0:t.activeElement)===e}_findFocusableDescendant(e){var o;const t='[slot="input"], input, textarea, select, button, [tabindex]:not([tabindex="-1"])';return e.querySelector(t)??((o=e.shadowRoot)==null?void 0:o.querySelector(t))??null}};k._nextGeneratedId=0;O([l({attribute:"for",reflect:!0})],k.prototype,"htmlFor",void 0);O([l({type:Boolean,reflect:!0})],k.prototype,"required",void 0);O([l({type:Boolean,reflect:!0})],k.prototype,"optional",void 0);O([l({attribute:"optional-label"})],k.prototype,"optionalLabel",void 0);k=M=O([v("co-label")],k);const We=_`
  :host {
    display: block;
    box-sizing: border-box;
    inline-size: 100%;
...
`;var C=function(r,e,t,o){var i=arguments.length,s=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(e,t,s):a(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s};let b=class extends re{constructor(){super(...arguments),this.orientation="vertical",this.selectionFollowsFocus=!1,this.rotateKeyboardNavigation=!1,this.hasNoDefaultSelected=!1,this.multipleChoice=!1,this.required=!1,this.requiredMessage="",this._validation=new z(this),this._handleModelValueChanged=e=>{var o;const t=e;t.target!==this||(o=t.detail)!=null&&o.initialize||this.dispatchEvent(new CustomEvent("co-change",{detail:{value:this.modelValue,modelValue:this.modelValue,checkedIndex:this.checkedIndex},bubbles:!0,composed:!0}))}}static get styles(){return[...super.styles,We]}connectedCallback(){super.connectedCallback(),this.addEventListener("model-value-changed",this._handleModelValueChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("model-value-changed",this._handleModelValueChanged)}firstUpdated(e){y(this),super.firstUpdated(e),this._syncValidation(!0,!0)}updated(e){y(this),super.updated(e),(e.has("validators")||e.has("required")||e.has("requiredMessage"))&&this._syncValidation(e.has("validators"),e.has("required")||e.has("requiredMessage"))}_labelTemplate(){return c`
      <div part="label" class="form-field__label">
        <slot name="label"></slot>
      </div>
    `}_helpTextTemplate(){return c`
    ...
    `}_syncValidation(e=!1,t=!1){this._validation.sync(()=>this.required?[I(this.requiredMessage,"Select an option.")]:[],e,t)}};C([l({reflect:!0})],b.prototype,"orientation",void 0);C([l({type:Boolean,attribute:"selection-follows-focus",reflect:!0})],b.prototype,"selectionFollowsFocus",void 0);C([l({type:Boolean,attribute:"rotate-keyboard-navigation",reflect:!0})],b.prototype,"rotateKeyboardNavigation",void 0);C([l({type:Boolean,attribute:"has-no-default-selected",reflect:!0})],b.prototype,"hasNoDefaultSelected",void 0);C([l({type:Boolean,attribute:"multiple-choice",reflect:!0})],b.prototype,"multipleChoice",void 0);C([l({type:Boolean,reflect:!0})],b.prototype,"required",void 0);C([l({attribute:"required-message"})],b.prototype,"requiredMessage",void 0);b=C([v("co-listbox")],b);class Xe extends K(W(L)){connectedCallback(){super.connectedCallback(),this.setAttribute("role","radiogroup")}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup=="function"?t.resetGroup():typeof t.reset=="function"&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}}class Ye extends se(ie){connectedCallback(){super.connectedCallback(),this.type="radio"}}const Ze=_`
  :host {
    display: block;
    font-family: var(--co-font-family-sans);
    font-size: var(--co-font-size-p);
...
`;var pe=function(r,e,t,o){var i=arguments.length,s=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(e,t,s):a(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s};let P=class extends Ye{constructor(){super(...arguments),this.__forwardingClick=!1}static get styles(){return[...super.styles,Ze]}get value(){return typeof this.choiceValue=="string"?this.choiceValue:""}set value(e){const t=this.value;this.choiceValue!==e&&(this.choiceValue=e),this.requestUpdate("value",t)}connectedCallback(){super.connectedCallback(),X(this)}render(){return c`
    ...
    `}_onMousedown(e){var t;((t=e.target)==null?void 0:t.slot)!=="input"&&e.preventDefault()}_onRadioClick(e){if(this.__forwardingClick||this.disabled)return;const t=e.target,o=this._inputNode;!o||t===o||t instanceof HTMLLabelElement||(this.__forwardingClick=!0,o.click(),o.focus(),this.__forwardingClick=!1)}};pe([l({reflect:!0})],P.prototype,"value",null);P=pe([v("co-radio")],P);const Je=_`
  :host {
    display: block;
    font-family: var(--co-font-family-sans);
    color: var(--co-color-text-default);
...
`;var J=function(r,e,t,o){var i=arguments.length,s=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(r,e,t,o);else for(var n=r.length-1;n>=0;n--)(a=r[n])&&(s=(i<3?a(s):i>3?a(e,t,s):a(e,t))||s);return i>3&&s&&Object.defineProperty(e,t,s),s};let T=class extends Xe{constructor(){super(...arguments),this.required=!1,this.requiredMessage="",this._validation=new z(this),this._handleModelValueChanged=e=>{var o;const t=e;t.target!==this||(o=t.detail)!=null&&o.initialize||this.dispatchEvent(new CustomEvent("co-change",{detail:{value:this.modelValue,modelValue:this.modelValue},bubbles:!0,composed:!0}))}}static get styles(){return[...super.styles,Je]}connectedCallback(){super.connectedCallback(),this.addEventListener("model-value-changed",this._handleModelValueChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("model-value-changed",this._handleModelValueChanged)}firstUpdated(e){y(this),super.firstUpdated(e),this._syncValidation(!0,!0)}updated(e){y(this),super.updated(e),(e.has("validators")||e.has("required")||e.has("requiredMessage"))&&this._syncValidation(e.has("validators"),e.has("required")||e.has("requiredMessage"))}render(){return c`
      <div part="label" class="form-field__label">
        <slot name="label"></slot>
      </div>
      <small part="help-text" class="form-field__help-text">
    ...
    `}_syncValidation(e=!1,t=!1){this._validation.sync(()=>this.required?[I(this.requiredMessage,"Select an option.")]:[],e,t)}};J([l({type:Boolean,reflect:!0})],T.prototype,"required",void 0);J([l({attribute:"required-message"})],T.prototype,"requiredMessage",void 0);T=J([v("co-radio-group")],T);export{K as ChoiceGroupMixin,jt as CoAppShell,Pt as CoBanner,Yt as CoButton,Jt as CoButtonIcon,Wt as CoCard,$ as CoCheckbox,A as CoCheckboxGroup,j as CoCheckboxIndeterminate,d as CoCombobox,H as CoForm,eo as CoIcon,Rt as CoInput,Bt as CoInputPill,k as CoLabel,b as CoListbox,ko as CoModeToggle,Fo as CoNavDrawer,No as CoNavDrawerGroup,Ao as CoNavDrawerItem,wo as CoNavHeaderBar,Io as CoNavRailBar,Ut as CoNavRailItem,Lo as CoNavSeparator,oo as CoOption,P as CoRadio,T as CoRadioGroup,_o as CoSelect,Do as CoTextarea,wt as DefaultSuccess,so as EqualsLength,ro as FocusMixin,Ee as FormControlMixin,xe as FormControlsCollection,W as FormGroupMixin,go as FormRegisteringMixin,ge as FormRegistrarMixin,bo as FormRegistrarPortalMixin,xo as FormatMixin,ao as InteractionStateMixin,xt as IsDate,Et as IsDateDisabled,no as IsEmail,_t as IsNumber,lo as IsString,Ro as LionField,yo as LionValidationFeedback,Ct as MaxDate,co as MaxLength,vt as MaxNumber,yt as MinDate,uo as MinLength,kt as MinMaxDate,ho as MinMaxLength,gt as MinMaxNumber,bt as MinNumber,Bo as NativeTextFieldMixin,po as Pattern,fo as Required,Ae as ResultValidator,G as Unparseable,we as ValidateMixin,m as Validator};
