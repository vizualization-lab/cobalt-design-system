import{A as m,E as p,i as g,a as u,b as v,t as y}from"./custom-element.CPWKJEuj.js";import{n as a}from"./property.C8dt_fM1.js";import{i as b,t as w,e as x}from"./directive.CJw_OlP2.js";import{b as z,c as C,d as $,o as S}from"./theme.CR1UbzdT.js";import"./framework.NLW_VnUw.js";/**
 * @license
...
`;var s=function(n,t,e,r){var c=arguments.length,i=c<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,t,e,r);else for(var h=n.length-1;h>=0;h--)(l=n[h])&&(i=(c<3?l(i):c>3?l(t,e,i):l(t,e))||i);return c>3&&i&&Object.defineProperty(t,e,i),i};let o=class extends u{constructor(){super(...arguments),this.name="",this.size="md",this.fill=!1,this.animated=!1}async replay(){if(!this.animated){this.animated=!0,await this.updateComplete;return}this.animated=!1,await this.updateComplete,this.getBoundingClientRect(),this.animated=!0,await this.updateComplete}render(){const t=this.animated&&z(this.name,"rounded",this.fill)||C(this.name,"rounded",this.fill);if(!t)return m;const e=!this.label,r=$.has(this.name)||S.has(this.name)?"0 0 24 24":"0 -960 960 960";return v`
      <svg
        part="svg"
    ...
    `}};o.styles=[I];s([a({reflect:!0})],o.prototype,"name",void 0);s([a({reflect:!0})],o.prototype,"size",void 0);s([a({type:Boolean,reflect:!0})],o.prototype,"fill",void 0);s([a({type:Boolean,reflect:!0})],o.prototype,"animated",void 0);s([a()],o.prototype,"label",void 0);o=s([y("co-icon")],o);export{o as CoIcon};
