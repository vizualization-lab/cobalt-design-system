 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ot=globalThis,eo=o=>o,St=ot.trustedTypes,to=St?St.createPolicy("lit-html",{createHTML:o=>o}):void 0,Io="$lit$",me=`lit$${Math.random().toFixed(9).slice(2)}$`,Lo="?"+me,Is=`<${Lo}>`,Ae=document,dt=()=>Ae.createComment(""),ct=o=>o===null||typeof o!="object"&&typeof o!="function",Oi=Array.isArray,Ls=o=>Oi(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",Ut=`[ 	
\f\r]`,Qe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,io=/-->/g,oo=/>/g,Ce=RegExp(`>|${Ut}(?:([^\\s"'>=/]+)(${Ut}*=${Ut}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),so=/'/g,ro=/"/g,Fo=/^(?:script|style|textarea|title)$/i,Fs=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),u=Fs(1),ae=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),no=new WeakMap,Ne=Ae.createTreeWalker(Ae,129);function zo(o,e){if(!Oi(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return to!==void 0?to.createHTML(e):e}const zs=(o,e)=>{const t=o.length-1,i=[];let s,r=e===2?"<svg>":e===3?"<math>":"",n=Qe;for(let a=0;a<t;a++){const d=o[a];let h,_,b=-1,p=0;for(;p<d.length&&(n.lastIndex=p,_=n.exec(d),_!==null);)p=n.lastIndex,n===Qe?_[1]==="!--"?n=io:_[1]!==void 0?n=oo:_[2]!==void 0?(Fo.test(_[2])&&(s=RegExp("</"+_[2],"g")),n=Ce):_[3]!==void 0&&(n=Ce):n===Ce?_[0]===">"?(n=s??Qe,b=-1):_[1]===void 0?b=-2:(b=n.lastIndex-_[2].length,h=_[1],n=_[3]===void 0?Ce:_[3]==='"'?ro:so):n===ro||n===so?n=Ce:n===io||n===oo?n=Qe:(n=Ce,s=void 0);const f=n===Ce&&o[a+1].startsWith("/>")?" ":"";r+=n===Qe?d+Is:b>=0?(i.push(h),d.slice(0,b)+Io+d.slice(b)+me+f):d+me+(b===-2?a:f)}return[zo(o,r+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class ht{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let r=0,n=0;const a=e.length-1,d=this.parts,[h,_]=zs(e,t);if(this.el=ht.createElement(h,i),Ne.currentNode=this.el.content,t===2||t===3){const b=this.el.content.firstChild;b.replaceWith(...b.childNodes)}for(;(s=Ne.nextNode())!==null&&d.length<a;){if(s.nodeType===1){if(s.hasAttributes())for(const b of s.getAttributeNames())if(b.endsWith(Io)){const p=_[n++],f=s.getAttribute(b).split(me),g=/([.?@])?(.*)/.exec(p);d.push({type:1,index:r,name:g[2],strings:f,ctor:g[1]==="."?$s:g[1]==="?"?Rs:g[1]==="@"?Ds:Lt}),s.removeAttribute(b)}else b.startsWith(me)&&(d.push({type:6,index:r}),s.removeAttribute(b));if(Fo.test(s.tagName)){const b=s.textContent.split(me),p=b.length-1;if(p>0){s.textContent=St?St.emptyScript:"";for(let f=0;f<p;f++)s.append(b[f],dt()),Ne.nextNode(),d.push({type:2,index:++r});s.append(b[p],dt())}}}else if(s.nodeType===8)if(s.data===Lo)d.push({type:2,index:r});else{let b=-1;for(;(b=s.data.indexOf(me,b+1))!==-1;)d.push({type:7,index:r}),b+=me.length-1}r++}}static createElement(e,t){const i=Ae.createElement("template");return i.innerHTML=e,i}}function He(o,e,t=o,i){var n,a;if(e===ae)return e;let s=i!==void 0?(n=t._$Co)==null?void 0:n[i]:t._$Cl;const r=ct(e)?void 0:e._$litDirective$;return(s==null?void 0:s.constructor)!==r&&((a=s==null?void 0:s._$AO)==null||a.call(s,!1),r===void 0?s=void 0:(s=new r(o),s._$AT(o,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=s:t._$Cl=s),s!==void 0&&(e=He(o,s._$AS(o,e.values),s,i)),e}class Ms{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=((e==null?void 0:e.creationScope)??Ae).importNode(t,!0);Ne.currentNode=s;let r=Ne.nextNode(),n=0,a=0,d=i[0];for(;d!==void 0;){if(n===d.index){let h;d.type===2?h=new gt(r,r.nextSibling,this,e):d.type===1?h=new d.ctor(r,d.name,d.strings,this,e):d.type===6&&(h=new Ps(r,this,e)),this._$AV.push(h),d=i[++a]}n!==(d==null?void 0:d.index)&&(r=Ne.nextNode(),n++)}return Ne.currentNode=Ae,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class gt{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=(s==null?void 0:s.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=He(this,e,t),ct(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==ae&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ls(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&ct(this._$AH)?this._$AA.nextSibling.data=e:this.T(Ae.createTextNode(e)),this._$AH=e}$(e){var r;const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ht.createElement(zo(i.h,i.h[0]),this.options)),i);if(((r=this._$AH)==null?void 0:r._$AD)===s)this._$AH.p(t);else{const n=new Ms(s,this),a=n.u(this.options);n.p(t),this.T(a),this._$AH=n}}_$AC(e){let t=no.get(e.strings);return t===void 0&&no.set(e.strings,t=new ht(e)),t}k(e){Oi(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const r of e)s===t.length?t.push(i=new gt(this.O(dt()),this.O(dt()),this,this.options)):i=t[s],i._$AI(r),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e!==this._$AB;){const s=eo(e).nextSibling;eo(e).remove(),e=s}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class Lt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}_$AI(e,t=this,i,s){const r=this.strings;let n=!1;if(r===void 0)e=He(this,e,t,0),n=!ct(e)||e!==this._$AH&&e!==ae,n&&(this._$AH=e);else{const a=e;let d,h;for(e=r[0],d=0;d<r.length-1;d++)h=He(this,a[i+d],t,d),h===ae&&(h=this._$AH[d]),n||(n=!ct(h)||h!==this._$AH[d]),h===y?e=y:e!==y&&(e+=(h??"")+r[d+1]),this._$AH[d]=h}n&&!s&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class $s extends Lt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}}class Rs extends Lt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}}class Ds extends Lt{constructor(e,t,i,s,r){super(e,t,i,s,r),this.type=5}_$AI(e,t=this){if((e=He(this,e,t,0)??y)===ae)return;const i=this._$AH,s=e===y&&i!==y||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==y&&(i===y||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class Ps{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){He(this,e)}}const Ht=ot.litHtmlPolyfillSupport;Ht==null||Ht(ht,gt),(ot.litHtmlVersions??(ot.litHtmlVersions=[])).push("3.3.2");const ti=(o,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let s=i._$litPart$;if(s===void 0){const r=(t==null?void 0:t.renderBefore)??null;i._$litPart$=s=new gt(e.insertBefore(dt(),r),r,void 0,t??{})}return s._$AI(o),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Vi={ATTRIBUTE:1,CHILD:2},Ii=o=>(...e)=>({_$litDirective$:o,values:e});let Li=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rt=(o,e)=>{var i;const t=o._$AN;if(t===void 0)return!1;for(const s of t)(i=s._$AO)==null||i.call(s,e,!1),rt(s,e);return!0},Ot=o=>{let e,t;do{if((e=o._$AM)===void 0)break;t=e._$AN,t.delete(o),o=e}while((t==null?void 0:t.size)===0)},Uo=o=>{for(let e;e=o._$AM;o=e){let t=e._$AN;if(t===void 0)e._$AN=t=new Set;else if(t.has(o))break;t.add(o),cr(e)}};function lr(o){this._$AN!==void 0?(Ot(this),this._$AM=o,Uo(this)):this._$AM=o}function dr(o,e=!1,t=0){const i=this._$AH,s=this._$AN;if(s!==void 0&&s.size!==0)if(e)if(Array.isArray(i))for(let r=t;r<i.length;r++)rt(i[r],!1),Ot(i[r]);else i!=null&&(rt(i,!1),Ot(i));else rt(this,o)}const cr=o=>{o.type==Vi.CHILD&&(o._$AP??(o._$AP=dr),o._$AQ??(o._$AQ=lr))};class hr extends Li{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),Uo(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,s;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)==null||i.call(this):(s=this.disconnected)==null||s.call(this)),t&&(rt(this,e),Ot(this))}setValue(e){if(Xs(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ci=class extends Li{constructor(e){if(super(e),this.it=y,e.type!==Vi.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this._t=void 0,this.it=e;if(e===ae)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ci.directiveName="unsafeHTML",ci.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let hi=class extends ci{};hi.directiveName="unsafeSVG",hi.resultType=2;const Wr=Ii(hi),Gr=T`
  /* ── Base ── */
  :host {
    display: inline-flex;
    align-items: center;
...
`;var ce=function(o,e,t,i){var s=arguments.length,r=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,t,i);else for(var a=o.length-1;a>=0;a--)(n=o[a])&&(r=(s<3?n(r):s>3?n(e,t,r):n(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r};let oe=class extends P{constructor(){super(...arguments),this.value="",this.icon="",this.selected=!1,this.disabled=!1,this._controlTabIndex=-1}setFocusable(e){this._controlTabIndex=!this.disabled&&e?0:-1,this._control&&(this._control.tabIndex=this._controlTabIndex)}focus(e){var t;(t=this._control)==null||t.focus(e)}get _iconSize(){return"sm"}_handleDisabledLinkClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}updated(){this._control&&(this._control.tabIndex=this.disabled?-1:this._controlTabIndex)}render(){const e=u`
    ...
    `,t=u`
      <span part="icon" class="nav-item__icon" aria-hidden="true">
        <slot name="icon">
          ${this.icon?u`<co-icon name=${this.icon} size=${this._iconSize}></co-icon>`:y}
        </slot>
      </span>
    `;return this.href?u`
        <a
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zo="important",Qr=" !"+Zo,Jt=Ii(class extends Li{constructor(o){var e;if(super(o),o.type!==Vi.ATTRIBUTE||o.name!=="style"||((e=o.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{const i=o[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(o,[e]){const{style:t}=o.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?t.removeProperty(i):t[i]=null);for(const i in e){const s=e[i];if(s!=null){this.ft.add(i);const r=typeof s=="string"&&s.endsWith(Qr);i.includes("-")||r?t.setProperty(i,r?s.slice(0,-11):s,r?Zo:""):t[i]=s}}return ae}}),Jo="4px",en="768px",tn="115px",on=T`
  :host {
    display: block;
    block-size: 100dvh;
...
`;var ts=function(o,e,t,i){var s=arguments.length,r=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,t,i);else for(var a=o.length-1;a>=0;a--)(n=o[a])&&(r=(s<3?n(r):s>3?n(e,t,r):n(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r};let fi=class extends ln{static get styles(){return[...super.styles,hn]}get value(){return typeof this.choiceValue=="string"?this.choiceValue:""}set value(e){const t=this.value;this.choiceValue!==e&&(this.choiceValue=e),this.requestUpdate("value",t)}connectedCallback(){super.connectedCallback(),qi(this)}get _indicatorIconName(){return this.indeterminate?"indeterminate-check-box":this.checked?"check-box":"check-box-outline-blank"}render(){return u`
    ...
    `}_syncRequiredValidator(){const e=this.validators,t=e.includes(this._requiredValidator);if(this.required&&!t){this.validators=[...e,this._requiredValidator];return}!this.required&&t&&(this.validators=e.filter(i=>i!==this._requiredValidator))}};is([v({type:Boolean,reflect:!0})],_i.prototype,"required",void 0);_i=is([R("co-checkbox-group")],_i);class un extends $r(P){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:"tabindex"}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox")}createRenderRoot(){return this}}const pn=o=>class extends Le(Fi(zt(ke(Ri(o))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:"selection-follows-focus"},rotateKeyboardNavigation:{type:Boolean,attribute:"rotate-keyboard-navigation"},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:"has-no-default-selected"},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],T`
          :host {
            display: block;
          }
...
`;var Rt=function(o,e,t,i){var s=arguments.length,r=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,t,i);else for(var a=o.length-1;a>=0;a--)(n=o[a])&&(r=(s<3?n(r):s>3?n(e,t,r):n(e,t))||r);return s>3&&r&&Object.defineProperty(e,t,r),r};let vt=class extends aa{constructor(){super(...arguments),this.size="md",this.danger=!1,this.required=!1,this._requiredValidator=new wt(void 0,{getMessage:async()=>"Please select an option."}),this._handleModelValueChanged=e=>{var i;const t=e;t.target!==this||(i=t.detail)!=null&&i.initialize||this.dispatchEvent(new CustomEvent("co-change",{detail:{value:this.modelValue,modelValue:this.modelValue,checkedIndex:this.checkedIndex},bubbles:!0,composed:!0}))}}static get styles(){return[...super.styles,la]}connectedCallback(){super.connectedCallback(),this.addEventListener("model-value-changed",this._handleModelValueChanged)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("model-value-changed",this._handleModelValueChanged)}firstUpdated(e){super.firstUpdated(e),this._syncRequiredValidator()}updated(e){super.updated(e),e.has("required")&&this._syncRequiredValidator(),this._syncChevronRotation()}_syncChevronRotation(){const e=this.querySelector(".select__chevron");e&&(e.style.transform=this.opened?"rotate(180deg)":"")}_labelTemplate(){return u`
      <div part="label" class="form-field__label">
        <slot name="label"></slot>
      </div>
    `}_helpTextTemplate(){return u`
    ...
    `}get slots(){return{...super.slots,invoker:()=>{const e=document.createElement("lion-select-invoker"),t=document.createElement("co-icon");return t.setAttribute("slot","after"),t.setAttribute("name","keyboard-arrow-down"),t.setAttribute("size",{sm:"xs",md:"sm",lg:"md",xl:"lg"}[this.size]??"sm"),t.setAttribute("aria-hidden","true"),t.classList.add("select__chevron"),e.appendChild(t),e}}}_inputGroupTemplate(){return u`
      <div part="input-group" class="input-group">
